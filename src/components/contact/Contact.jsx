        ...
        >
            <motion.div className="wrapper">
                <motion.div className="textContainer" variants={variants} >
                    ...
                    <motion.div className="subTextContainer" variants={variants}>
                        <h2>Mail</h2>
                        <p>test@123gmail.com</p>
                    </motion.div>
                    <motion.div className="subTextContainer" variants={variants}>
                        <h2>Address</h2>
                        <p>H.no.86, sec-68 Noida G.B.Nagar,U.P,INDIA</p>
                    </motion.div>
                    <motion.div className="subTextContainer" variants={variants}>
                        <h2>Phone</h2>
                        <p>+91-9560269092</p>
                ...
                <motion.div className="formContainer" variants={variants}>
                    ...
                    transition={{delay:4,duration:1}}
                     >
                        <svg height="450px" width="450px" viewBox="0 0 32.663 32.663 ">
                            <motion.path
                                strokeWidth={0.2}
                                fill="none"
